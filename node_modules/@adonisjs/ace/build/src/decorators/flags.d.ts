...
export declare const flags: {
     ...
     */
    string<Type = string>(options?: Partial<Omit<StringFlag<Type>, "type">> | undefined): <Key extends string, Target extends { [K in Key]?: Type | undefined; }>(target: Target, propertyName: Key) => void;
    /**
