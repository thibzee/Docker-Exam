...
export declare const args: {
     ...
     */
    string<Type = string>(options?: Partial<Omit<StringArgument<Type>, "type">> | undefined): <Key extends string, Target extends { [K in Key]?: Type | undefined; }>(target: Target, propertyName: Key) => void;
    /**
