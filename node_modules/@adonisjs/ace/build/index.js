...
var IndexGenerator = class {
  ...
  async generate() {
    ...
    const indexFile = join2(this.#commandsDir, "commands.json");
    const loaderFile = join2(this.#commandsDir, "main.js");
    const loaderStub = join2(stubsRoot, "commands_loader.stub");
    const loaderTypes = join2(this.#commandsDir, "main.d.ts");
    const loaderTypesStub = join2(stubsRoot, "commands_loader_types.stub");
