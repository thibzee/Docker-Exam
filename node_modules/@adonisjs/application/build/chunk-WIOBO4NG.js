...
var RcFileParser = class {
  ...
  #getAssemblerRunner() {
    ...
    if (!this.#rcFile.unstable_assembler.runner.name) {
      throw new E_MISSING_ASSEMBLER_RUNNER_NAME();
    }
    if (!this.#rcFile.unstable_assembler.runner.command) {
      throw new E_MISSING_ASSEMBLER_RUNNER_COMMAND();
    }
    return {
  ...
  #getAssembler() {
    ...
    return new ObjectBuilder({}).add("runner", runner).add("onBuildStarting", this.#rcFile.unstable_assembler.onBuildStarting).add("onBuildCompleted", this.#rcFile.unstable_assembler.onBuildCompleted).add("onDevServerStarted", this.#rcFile.unstable_assembler.onDevServerStarted).add("onSourceFileChanged", this.#rcFile.unstable_assembler.onSourceFileChanged).add("onHttpServerMessage", this.#rcFile.unstable_assembler.onHttpServerMessage).toObject();
  }
  /**
...
//# sourceMappingURL=chunk-WIOBO4NG.js.map